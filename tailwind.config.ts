  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Surakshabot Glass Theme Colors
        glass: {
        ...
        "light-purple": {
          primary: "hsl(var(--light-purple-primary))",
          secondary: "hsl(var(--light-purple-secondary))",
          accent: "hsl(var(--light-purple-accent))",
          background: "hsl(var(--light-purple-background))",
